...
class Product(models.Model):
    Availability = (('In stock' , 'Instock') ,('Out of stock' , 'Out of stock'))

    category = models.ForeignKey(Category,default='',null=False,on_delete=models.CASCADE)
    sub_category = models.ForeignKey(subcategory,default='',null=False,on_delete=models.CASCADE)
